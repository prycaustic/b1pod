...
public class Music extends ListenerAdapter
{
    ...
    public void onGuildMessageReceived(@NotNull GuildMessageReceivedEvent event)
    {
        ...
        {
            loadAndPlay(event.getChannel(), args[1], event.getMessage());
        }
        else if (content.startsWith(prefix + "skip"))
        {
            skipTrack(event.getChannel());
        }
        else if (content.startsWith(prefix + "disconnect") || content.startsWith(prefix + "dc"))
        {
    ...
    private void loadAndPlay(final TextChannel channel, final String trackUrl, final Message message) {
